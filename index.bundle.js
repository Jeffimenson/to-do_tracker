    ...
    #generateQuestEntry(quest, index, questGroup) {
        ...
        entry.addEventListener("dragenter", () => {
            if (this.#currDraggedIndex !== index) {
                ...
                const newParent = (0,_jeffQuery_js__WEBPACK_IMPORTED_MODULE_0__.query)(`.quests [data-index="${index}"`); // change this later to display selectedQuestIndex quest instead of currently dragged quest
                const newButton = (0,_jeffQuery_js__WEBPACK_IMPORTED_MODULE_0__.query)('.quest-select', newParent);
    ...
    #generateTaskEntry(quest, taskIndex) {
        ...
        entry.addEventListener("dragenter", () => {
            if (this.#currDraggedIndex !== taskIndex) {
                ...
                const newParent = (0,_jeffQuery_js__WEBPACK_IMPORTED_MODULE_0__.query)(`.tasks [data-index="${taskIndex}"`); // change this later to display selectedQuestIndex quest instead of currently dragged quest
