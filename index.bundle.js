            ...
            entryInput.addEventListener("change", () => {
                ...
                if (checked) {
                    ...
                    if (quest.isComplete){
                        ...
                        const associatedLiEntry = (0,_jeffQuery_js__WEBPACK_IMPORTED_MODULE_1__.query)(`[data-index='${selectedQuestIndex}]`, compQuestList);
                        console.log({associatedLiEntry, selectedQuestIndex});
                        for (let i = 0; i < uncompleted.length; i++){
                            const currentIndex = (0,_jeffQuery_js__WEBPACK_IMPORTED_MODULE_1__.query)('button', uncompleted[i]).dataset.index;
