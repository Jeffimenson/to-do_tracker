...
function getStaticHandler() {
    ...
    const getInputVals = () => {
        const questName = (0,_jeffQuery_js__WEBPACK_IMPORTED_MODULE_0__.query)('#get-quest-name').value;

        const dueInput = (0,_jeffQuery_js__WEBPACK_IMPORTED_MODULE_0__.query)('#get-quest-due');
    ...
    const getTimeDisplay = (quest) => {
        const dueDisplay = (0,_jeffQuery_js__WEBPACK_IMPORTED_MODULE_0__.make)('button.due');
