...
/* harmony export */   QuestGroup: () => (/* binding */ QuestGroup),
...
class User {
    staticQuests = new _quests_js__WEBPACK_IMPORTED_MODULE_2__.QuestGroup();
    dailyQuests = new _quests_js__WEBPACK_IMPORTED_MODULE_2__.QuestGroup();
    weeklyQuests = new _quests_js__WEBPACK_IMPORTED_MODULE_2__.QuestGroup();
    
    constructor() {}

    makeStaticQuest(name, tasks, due){
        const qst = new _quests_js__WEBPACK_IMPORTED_MODULE_2__.Quest(name, tasks, due);
    ...
    makeDailyQuest(name, tasks, time){
        ...
        const qst = new _quests_js__WEBPACK_IMPORTED_MODULE_2__.Quest(name, tasks, date);
