...
.more-quest-options.hidden {
    display: none;
}

div.more-quest-options > button {
    padding: 2px 5px;
    border: 1px solid transparent;
}

div.more-quest-options > button:hover {
    border: 1px solid var(--pip-green);
}

ul.quests li button.more:hover {
        ...
        const content = (0,_jeffQuery_js__WEBPACK_IMPORTED_MODULE_1__.make)('div.content', main);
            const leftSection = (0,_jeffQuery_js__WEBPACK_IMPORTED_MODULE_1__.make)('section.left', content);
                const questContainer = (0,_jeffQuery_js__WEBPACK_IMPORTED_MODULE_1__.make)('div.quest-container', leftSection);
                    const questPrompt = (0,_jeffQuery_js__WEBPACK_IMPORTED_MODULE_1__.make)('div.quest-prompt', questContainer);
                        ...
                        questPromptBody.setAttribute("method", "post");
                            ...
                            const questDueLabel = (0,_jeffQuery_js__WEBPACK_IMPORTED_MODULE_1__.make)("label", questPromptBody);
        ...
        for (let i = 0; i < quests.length; i++){
            ...
            entry.dataset.index = i;
                ...
                if (quests[i].dueDate != null){
                    const dueDisplay = (0,_jeffQuery_js__WEBPACK_IMPORTED_MODULE_1__.make)('button.due', entry);
            ...
            const moreButton = (0,_jeffQuery_js__WEBPACK_IMPORTED_MODULE_1__.make)('button.more', entry);
                ...
                const moreOptions = (0,_jeffQuery_js__WEBPACK_IMPORTED_MODULE_1__.make)('div.more-quest-options.hidden', moreButton);
                    const deleteQuest = (0,_jeffQuery_js__WEBPACK_IMPORTED_MODULE_1__.make)('button.delete-quest', moreOptions);
                    ...
                    const editQuestName = (0,_jeffQuery_js__WEBPACK_IMPORTED_MODULE_1__.make)('button.edit-quest-name', moreOptions);
                    editQuestName.textContent = 'Edit';

                    editQuestName.addEventListener('click', () => {
                        entry.classList.add('hidden');

                        const editor = (0,_jeffQuery_js__WEBPACK_IMPORTED_MODULE_1__.make)('input.quest-editor');
