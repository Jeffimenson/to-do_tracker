...
function getStaticHandler() {
    ...
    const getInputVals = () => {
        const questName = (0,_jeffQuery_js__WEBPACK_IMPORTED_MODULE_0__.query)('.quest-prompt .get-quest-name').value;
